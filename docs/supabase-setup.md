...
This repo now includes the schema proposal and frontend-safe config hooks needed to prepare an owned intake layer. It does not switch the live site away from FormSubmit yet.
